...
function highlight(code, options) {
    ...
    var html;
    if (options.language) {
        html = highlight_js_1.default.highlight(code, { language: options.language, ignoreIllegals: options.ignoreIllegals }).value;
    }
    else {
        html = highlight_js_1.default.highlightAuto(code, options.languageSubset).value;
    }
...
function supportsLanguage(name) {
    return !!highlight_js_1.default.getLanguage(name);
}
